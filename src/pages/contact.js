    ...
    <div>
        ...
        <main>
            <div className="mt-4 pt-4 text-center max-w-xl mx-auto">
                ...
                <p>To place an order fill out the form below send us a text or call now:  <a href="tel:+1-‪323-963-3322‬"><span className="font-bold hover:underline">(323) 963-3322‬.</span></a></p>
