...
const Feature = () => {
    ...
    return (
        <div className="text-text">
            ...
            <p className="mb-4 text-brown">We bake small batches of sourdough bread<br />in West Hollywood!</p>
            <p><span className="font-bold">Contact us to find out our baking schedule <br />and pre-order today!</span></p>
            <Button />
