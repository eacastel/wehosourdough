  ...
  const showForm = (
    ...
    <h5 className="font-bold mb-2">Select your Sourdough Bread:</h5>
      <div className="ml-4">
        ...
        <label for="olives"><input className="mt-2" type="checkbox" id="olives" ref={register} name="olives" value="Olives" /> Olive Weho Sourdough (Includes Olives, Pecans, Grated Lemon Zast, Herbs de Provance,) (+ $5)</label><br />
